                ...
                <div class="topic_header">OCCUPATION</div>
                <div class="body_text">PHP Back-end Programmer, specialized in WordPress.</div>

                <div class="topic_header">ABOUT ME</div>
                <div class="body_text">
                    I'm an experienced PHP programmer, focused on WordPress development. I have worked on big agencies
                    ...
                    play games, ride my skateboard and bike and, hopefully soon, to surf. I`m family guy and I love to <a href="<?= wp_get_attachment_url(8) ?>" data-lightbox="baby">share my hobbies with my girlfriend</a>, which is a one-of-a-kind girl.
                    And of course, I'm a <a href="<?= wp_get_attachment_url(9) ?>" data-lightbox="meme" data-title="When someone understands your meme reference.">fluent speaker of memes</a>.
                </div>

                <!-- Photos -->
                <a href="<?= wp_get_attachment_url(10) ?>" data-lightbox="motorcycle"></a>
                <a href="<?= wp_get_attachment_url(12) ?>" data-lightbox="motorcycle"></a>
                <a href="<?= wp_get_attachment_url(13) ?>" data-lightbox="motorcycle"></a>
                <a href="<?= wp_get_attachment_url(14) ?>" data-lightbox="motorcycle"></a>

                <div class="topic_header">LINKS</div>
                <div class="body_text">
